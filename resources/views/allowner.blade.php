            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                       <h3>সকল যানবাহন মালিকের লাইসেন্স</h3>
                    </header>
                    <div class="row">
                                ...
                                @foreach($allowner as $data)
                                    <tr class="gradeX">
                                        ...
                                        <td width="7%">
                                            ...
                                            <a class="btn btn-primary btn-xs" href="{{url('/')}}/owner/{{ $data->id }}" target="_blank">Print</a>

                                            <button  class="btn btn-default btn-xs" style="margin-top: 2px" type="button" onclick="editliecnceowner( {{ $data->id }})">Edit</button>
